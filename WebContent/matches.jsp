	...
	<p>
		<%
			...
			if (request.getParameter("update") != null) {
				conn.updateMatch(Integer.parseInt(request.getParameter("id")),new FootballMatch(new Team(request.getParameter("local_team")),
						Integer.parseInt(request.getParameter("local_goals")),new Team(request.getParameter("visitor_team")),
						Integer.parseInt(request.getParameter("visitor_goals"))));
			}

			if (request.getParameter("insert") != null) {
				conn.insertMatch(new FootballMatch(new Team(request.getParameter("local_team")),
						Integer.parseInt(request.getParameter("local_goals")),new Team(request.getParameter("visitor_team")),
						Integer.parseInt(request.getParameter("visitor_goals"))));
			}
